...
1. Ingest public reviews from the last 8–12 weeks (configurable window) from both Apple App Store (e.g. iTunes customer-reviews RSS) and Google Play (scraper-based), per product.
...
* Architecture and implementation plan traceability: every requirement above maps to modules, MCP usage, and phased exit criteria in [docs/architecture.md](about:blank) and [docs/implementationPlan.md](about:blank).
