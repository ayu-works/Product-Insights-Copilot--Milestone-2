...
Derived from `docs/Architecture.md`. The build is split into 8 incremental phases. Each phase produces something independently testable and, from Phase 1 onward, demoable via the CLI.
...
| Phase | Name                                  | Duration   | Key Deliverable                                                     | Blocks |
|-------|---------------------------------------|------------|---------------------------------------------------------------------|--------|
...
- Evaluations: `docs/phases/phase-0-foundations/evaluations.md`
- Edge cases: `docs/phases/phase-0-foundations/edge-cases.md`
...
- Evaluations: `docs/phases/phase-1-ingestion/evaluations.md`
- Edge cases: `docs/phases/phase-1-ingestion/edge-cases.md`
...
- Evaluations: `docs/phases/phase-2-clustering/evaluations.md`
- Edge cases: `docs/phases/phase-2-clustering/edge-cases.md`
...
- `agent/summarization.py`:
  - Pydantic response models for every LLM call; structured JSON output (function calling / `json_object`).
...
- Evaluations: `docs/phases/phase-3-summarization/evaluations.md`
- Edge cases: `docs/phases/phase-3-summarization/edge-cases.md`
...
- No MCP calls in this phase — pure local rendering.

### Exit Criteria

- Golden-image test: `doc_requests.json` and `email.html` are byte-stable on fixture input.
- Schema validator rejects malformed summaries (missing themes, wrong sentiment enum).

### References

- Evaluations: `docs/phases/phase-4-renderer/evaluations.md`
- Edge cases: `docs/phases/phase-4-renderer/edge-cases.md`
...
- Choose and pin a Google Docs MCP server (community or official); add it to `docker-compose.yml`.
...
- `agent/mcp_client/docs_ops.py`:
  ...
  - `append_pulse_section(docId, doc_requests, anchor) -> {headingId, deep_link}`:
    ...
    3. `docs.get_document` again → locate new heading by anchor, return its `headingId`.
...
- Evaluations: `docs/phases/phase-5-docs-mcp/evaluations.md`
- Edge cases: `docs/phases/phase-5-docs-mcp/edge-cases.md`
...
- Pin a Gmail MCP server; add to `docker-compose.yml`.
...
- Evaluations: `docs/phases/phase-6-gmail-mcp/evaluations.md`
- Edge cases: `docs/phases/phase-6-gmail-mcp/edge-cases.md`
...
- Evaluations: `docs/phases/phase-7-orchestration/evaluations.md`
- Edge cases: `docs/phases/phase-7-orchestration/edge-cases.md`
